...
public class ISS extends Entity implements EntityFeatures {

    public ISS(){
        position = new Vector(-20.0f, 7.0f);
        vao = new VertexArrayObject(ISSVertices, indices, textureCoordinates);
        shader = new Shader(vertexSource, fragmentSource);
        texture = new Texture(ISSTextureSource);
        ...
        setSize(ISSSize);
        setTriggerAttitude(random.nextInt(20) + 140);
