...
public class Comet extends Entity implements EntityFeatures {

    public Comet(){
        position = new Vector(-20.0f, 10.0f);
        vao = new VertexArrayObject(cometVertices, indices, textureCoordinates);
